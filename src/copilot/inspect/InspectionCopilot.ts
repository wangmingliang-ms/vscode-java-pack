...
import { TextDocument, DocumentSymbol, SymbolKind, ProgressLocation, commands, Position, Range, Selection, window, LanguageModelChatSystemMessage, LanguageModelChatMessage, LanguageModelChatUserMessage, LanguageModelChatAssistantMessage } from "vscode";
...
export default class InspectionCopilot extends Copilot {
    ...
    **efficient** and **concise** for given code.
     ...
     */
    private inspectCode(code: string, context: ProjectContext, key?: string, wait?: number): Promise<Inspection[]> {
